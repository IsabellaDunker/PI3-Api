...
router.get('/reports/waiter', verifyJWT, OrderController.reportsW)
router.get('/reports/products', verifyJWT, OrderController.reportsP)
router.get('/reports/date', verifyJWT, OrderController.reportsD)
